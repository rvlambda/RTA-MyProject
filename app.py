...
def main():
    with st.form('prediction_form'):
        ...
        Types_of_junction = st.selectbox("Select type of Junction : ", options=options_junction_typ)
        Sex_of_casualty = st.selectbox("Select sex of casualty : ", options=options_casualty_sex)
